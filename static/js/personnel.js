...
function addRow(p) {
    ...
    tr.innerHTML = `
        ...
        <td class="cell-actions">
            <button class="btn btn-small" onclick="startEdit(${p.id})">Modifica</button>
            <button class="btn btn-small btn-danger" onclick="remove(${p.id})">Elimina</button>
        </td>
    `;
...
async function remove(id) {
    if (!confirm('Disattivare questo membro del personale?')) return;
